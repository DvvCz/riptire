...
export default function Subscriptions() {
	const [subscriptions] = createResource(async () => await getSubscriptionsPage(Object.keys(await getSubscriptions())));

	return (
		<div class="flex flex-row flex-wrap gap-2 p-4">
			<Show when={!subscriptions.loading} fallback={"abracadabraabracadabra".split('').map(_ => <VideoMediumSkeleton />)}>
				{(() => {
